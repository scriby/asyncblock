...
var parseSyncArgs = function(args){
    ...
    if(typeof args[0] === 'function'){
        ...
        var arg0 = args[0];
        var arg0_type = Object.prototype.toString.call(arg0);

        if(arg0_type === "[object Array]"){
            options.responseFormat = arg0;
        } else if(arg0_type === "[object Object]"){
            options = arg0;
        }
        toExecute = args[1];
        applyBegin = 2;
