...
exports.enableTransform = function(){
    ...
    mod._compile = function(content, filename) {
        ...
        try {
            ...
            console.log('asyncblock was unable to transform ' + filename);
        ...
        var topLevel = traversal.forEach(function(){
            ...
            if(node != null){
                ...
                if(containingScope){
                    if(node[0] === 'function') {// && asyncblockVarId != null && containingScope.variables[node[1][1]] === asyncblockVarId){
                        var parent2x = this.parent.parent.node;
